            ...
            <div class="row details_row">
                <div class="col-lg-6">
                    <div class="details_image">
                        <div class="details_image_large"><img :src="$base_url+product.media.primary" :alt="product.name"></div>
                        <div class="mt-3 row align-items-center justify-content-start">
                            <div class="details_image_thumbnail col-3 d-flex align-items-center"><img :src="$base_url+product.media.primary" :alt="product.name"></div>
                            ...
                            <div class="details_image_thumbnail col-3 d-flex align-items-center" v-for="image in product.media.image" :key="image">
                                <img :src="$base_url+image" :alt="product.name">
                            </div>
                        </div>
                    </div>
                </div>
